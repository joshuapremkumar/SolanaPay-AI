import { type Plugin, type Action, elizaLogger, type Memory } from "@elizaos/core";
import {
  Connection,
  Keypair,
  PublicKey,
...
export const transactionLog: Array<{
  timestamp: Date;
  type: string;
  from: string;
  to: string;
...
export const solanaPaymentPlugin: Plugin = {
  name: "solana-payment",
